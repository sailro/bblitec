...
const vertexSource = wgsl`struct VertexOutput{@builtin(position) position:vec4<f32>,};
...
const fragmentSource = wgsl`struct VertexOutput{@builtin(position) position:vec4<f32>,};
