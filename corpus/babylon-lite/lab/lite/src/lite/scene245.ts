...
async function main(): Promise<void> {
    ...
    const root = await loadGltf(engine, "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Assets@main/Models/RecursiveSkeletons/glTF/RecursiveSkeletons.gltf");
