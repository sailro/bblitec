/** Scene 69 — Scene 68 + SheenBlock.
 *
 *  Adds a hot magenta sheen layer on top of a dark purple PBR sphere. The sheen is wired
 *  to PBR-MR.sheen and exposes intensity / color / roughness via three
 *  InputBlocks. A softened ClearCoat layer stays connected to validate the two
 *  layers compose correctly without hiding the colored fabric-like rim.
 */
export const SCENE69_NME_JSON = {
    tags: null,
    ignoreAlpha: false,
