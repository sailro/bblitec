...
| 248 | <img src="images/scenes/scene248.png" alt="Scene 248 rendering" width="120"> | $\color{#1a7f37}{\textsf{0.001}}$ / $\color{#1a7f37}{\textsf{0.005}}$ | $\color{#9a6700}{\textsf{0.678}}$ / $\color{#cf222e}{\textsf{3.876}}$ | external glTF and sampler modes |
| 249 | <img src="images/scenes/scene249.png" alt="Scene 249 rendering" width="120"> | $\color{#1a7f37}{\textsf{0.001}}$ / $\color{#1a7f37}{\textsf{0.024}}$ | $\color{#1a7f37}{\textsf{0.140}}$ / $\color{#cf222e}{\textsf{6.057}}$ | vertex-color alpha and mask cutoff |
...
| 259 | <img src="images/scenes/scene259.png" alt="Scene 259 rendering" width="120"> | $\color{#1a7f37}{\textsf{0.000}}$ / $\color{#1a7f37}{\textsf{0.000}}$ | $\color{#1a7f37}{\textsf{0.466}}$ / $\color{#9a6700}{\textsf{0.998}}$ | factor-only emissive material with neutral texture fallback |
