...
| 253 | <img src="images/scenes/scene253.png" alt="Scene 253 rendering" width="160"> | $\color{#1a7f37}{\textsf{0.251}} / \color{#cf222e}{\textsf{3.841}}$ | $\color{#1a7f37}{\textsf{0.209}} / \color{#cf222e}{\textsf{3.218}}$ | `KHR_animation_pointer` across node transforms, punctual lights and material extensions, spot lights, 69 channels. The region figure carries a known defect, not a floor: the IOR sphere's interior differs from the reference and both backends agree to one channel step |
