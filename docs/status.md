...
| 6 | <img src="images/scenes/scene6.png" alt="Scene 6 rendering" width="120"> | $\color{#1a7f37}{\textsf{0.284}}$ | $\color{#1a7f37}{\textsf{0.022}}$ | specular-glossiness gold sphere, solid textures, and finite requested DDS skybox |
...
| 14 | <img src="images/scenes/scene14.png" alt="Scene 14 rendering" width="120"> | $\color{#cf222e}{\textsf{2.430}}$ | $\color{#1a7f37}{\textsf{0.092}}$ | Flight Helmet glTF with default framing, IBL, and finite translated DDS skybox<br><em>The still-opt-in requested ground lowers this to 0.290/0.051; ground composition remains open because it regresses Scenes 1, 6, and 13.</em> |
...
| 33 | <img src="images/scenes/scene33.png" alt="Scene 33 rendering" width="120"> | $\color{#1a7f37}{\textsf{0.174}}$ | $\color{#cf222e}{\textsf{4.093}}$ | `KHR_lights_punctual` physical-falloff accumulation through opaque, transmission, and BLEND-alpha composition<br><em>Authored opaque transmission retains depth/write state; the remaining error is 86% raster-edge attribution.</em> |
...
| 176 | <img src="images/scenes/scene176.png" alt="Mosquito in Amber" width="120"> | $\color{#1a7f37}{\textsf{0.339}}$ | $\color{#1a7f37}{\textsf{0.339}}$ | integrated linear transmission, authored alpha state, IOR, volume, and scene-color copy |
...
| 212 | <img src="images/scenes/scene212.png" alt="Scene 212 rendering" width="120"> | $\color{#9a6700}{\textsf{0.608}}$ | $\color{#9a6700}{\textsf{0.673}}$ | `KHR_materials_dispersion` per-RGB refraction over transmission, IOR, and volume<br><em>Residual error is refracted checkerboard and silhouette coverage; Babylon Lite's original parity PR likewise records a native-resolution MSAA edge-resolve floor.</em> |
...
| 247 | <img src="images/scenes/scene247.png" alt="Scene 247 rendering" width="120"> | $\color{#1a7f37}{\textsf{0.055}}$ | $\color{#9a6700}{\textsf{0.644}}$ | `EXT_mesh_gpu_instancing` with one native instanced draw |
