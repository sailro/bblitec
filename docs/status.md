...
| Platformer | <img src="images/scenes/platformer.png" alt="Platformer rendering" width="160"> | $\color{#9a6700}{\textsf{0.773}} / \color{#9a6700}{\textsf{0.773}}$ | $\color{#9a6700}{\textsf{0.770}} / \color{#9a6700}{\textsf{0.770}}$ | Sprite game; CRT pass; audio; retained UI. UI residual; no-UI MAD: SDL_GPU 0.013 / 0.013, Dawn 0.010 / 0.010. |
