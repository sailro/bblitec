...
| Cameras | ArcRotate, FreeCamera, default framing, native controls, target assignment and reads, per-frame clamping of the reached properties |
| Lights | directional, hemispheric and point with diffuse/specular colors; two Standard lights; two PBR analytic lights, either kind in either slot |
| Geometry | box, sphere, subdivided ground, plane, torus; `createMeshFromData` typed-array meshes; fixed-capacity thin-instance pools with per-frame flush and count updates; indexed glTF/GLB and `.babylon`; generated and flat normals; negative transforms |
...
| Materials | Standard, PBR, GridMaterial, vertex colors; the opt-in setters `setPbrUnlit`, `setPbrSkybox` and `setPbrEmissive`; scene-local shader variants compiled from the entry file's own WGSL, with typed uniforms resolved to reflected offsets |
...
| Animation | deterministic seeking; property-animation groups over position/scaling/quaternion with LINEAR/STEP tracks; glTF LINEAR/CUBICSPLINE transforms and LINEAR morph weights |
...
| 248 | <img src="images/scenes/scene248.png" alt="Scene 248 rendering" width="160"> | $\color{#1a7f37}{\textsf{0.001}}$&nbsp;/&nbsp;$\color{#1a7f37}{\textsf{0.005}}$ | $\color{#1a7f37}{\textsf{0.001}}$&nbsp;/&nbsp;$\color{#1a7f37}{\textsf{0.004}}$ | external glTF and sampler modes |
| 249 | <img src="images/scenes/scene249.png" alt="Scene 249 rendering" width="160"> | $\color{#1a7f37}{\textsf{0.001}}$&nbsp;/&nbsp;$\color{#1a7f37}{\textsf{0.024}}$ | $\color{#1a7f37}{\textsf{0.001}}$&nbsp;/&nbsp;$\color{#1a7f37}{\textsf{0.024}}$ | vertex-color alpha and mask cutoff |
...
| runtime-sweep | <img src="images/scenes/regression-runtime-sweep.png" alt="Runtime sweep rendering" width="160"> | $\color{#1a7f37}{\textsf{0.000}}$&nbsp;/&nbsp;$\color{#1a7f37}{\textsf{0.001}}$ | $\color{#1a7f37}{\textsf{0.000}}$&nbsp;/&nbsp;$\color{#1a7f37}{\textsf{0.001}}$ | typed-array meshes, thin-instance pools with flush and count updates, handles inside data retired by `removeFromScene`, file-texture sampler contract |
| regression-instanced-ground | <img src="images/scenes/regression-instanced-ground.png" alt="Instanced ground rendering" width="160"> | $\color{#1a7f37}{\textsf{0.136}}$&nbsp;/&nbsp;$\color{#1a7f37}{\textsf{0.089}}$ | $\color{#1a7f37}{\textsf{0.136}}$&nbsp;/&nbsp;$\color{#1a7f37}{\textsf{0.089}}$ | `EXT_mesh_gpu_instancing` with the requested environment ground |
| regression-morph-ground | <img src="images/scenes/regression-morph-ground.png" alt="Morph storage ground rendering" width="160"> | $\color{#1a7f37}{\textsf{0.150}}$&nbsp;/&nbsp;$\color{#1a7f37}{\textsf{0.190}}$ | $\color{#1a7f37}{\textsf{0.150}}$&nbsp;/&nbsp;$\color{#1a7f37}{\textsf{0.190}}$ | storage-buffer morphing with the requested environment ground |
