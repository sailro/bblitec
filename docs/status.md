...
| --- | --- |
| TypeScript modules/functions | named local imports and re-exports, module constants, typed non-generic function parameters/defaults, one final return, lexical block scopes/shadowing, if/else, numeric for/while loops, recursion rejection |
