...
| Geometry | box, sphere, subdivided ground, plane, torus; `createMeshFromData` typed-array meshes; fixed-capacity thin-instance pools with per-frame flush and count updates; indexed glTF/GLB and `.babylon`; glTF triangle-list and triangle-strip primitive modes; generated and flat normals; negative transforms |
