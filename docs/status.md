...
| --- | :---: | ---: | ---: | --- |
| Ocean | <img src="images/scenes/ocean.png" alt="Ocean rendering" width="160"> | 0.420 / 0.424 | 0.420 / 0.424 | Spectral ocean; compute FFT and mipmaps; procedural sky; buoyancy; retained controls; canvas-only MAD: 0.008 / 0.008 on both backends. |
