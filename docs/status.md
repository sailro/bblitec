...
| 6 | <img src="images/scenes/scene6.png" alt="Scene 6 rendering" width="120"> | $\color{#1a7f37}{\textsf{0.282}}$ | $\color{#1a7f37}{\textsf{0.023}}$ | specular-glossiness gold sphere, solid textures, and requested DDS skybox |
...
| 265 | <img src="images/scenes/scene265.png" alt="Scene 265 rendering" width="120"> | $\color{#1a7f37}{\textsf{0.307}}$ | $\color{#cf222e}{\textsf{9.316}}$ | `EXT_lights_image_based` RGBD cubemap, SH irradiance, BRDF LUT, and rotation |
