...
| --- | :---: | ---: | ---: | --- |
| Ocean | <img src="images/scenes/ocean.png" alt="Ocean rendering" width="160"> | 0.307 / 0.302 | 0.306 / 0.302 | Spectral ocean; compute FFT and mipmaps; procedural sky; buoyancy; retained controls; canvas-only MAD: 0.008 / 0.008 on both backends. |
...
| Freeciv | <img src="images/scenes/freeciv.png" alt="Freeciv rendering" width="160"> | 0.162 / 0.161 | 0.145 / 0.143 | Strategy map; sprites; picking; retained cursor/tooltips. |
