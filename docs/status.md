...
| 248 | <img src="images/scenes/scene248.png" alt="Scene 248 rendering" width="120"> | $\color{#1a7f37}{\textsf{0.001}}$ / $\color{#1a7f37}{\textsf{0.005}}$ | $\color{#1a7f37}{	extsf{0.003}}$ / $\color{#1a7f37}{	extsf{0.016}}$ | external glTF and sampler modes |
| 249 | <img src="images/scenes/scene249.png" alt="Scene 249 rendering" width="120"> | $\color{#1a7f37}{\textsf{0.001}}$ / $\color{#1a7f37}{\textsf{0.024}}$ | $\color{#1a7f37}{	extsf{0.012}}$ / $\color{#1a7f37}{	extsf{0.499}}$ | vertex-color alpha and mask cutoff |
