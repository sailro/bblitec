...
Apps use landscape orientation and immersive fullscreen; system Back exits the activity. Multi-touch supports simultaneous UI controls
and camera gestures. Multiple native windows and Dawn remain unsupported. Full corpus and
