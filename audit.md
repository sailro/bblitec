...
| CC-14 | L | partial | Native architecture tests still inspect source text | test/compiler-architecture.test.ts | Compiler dependencies use AST checks and renamed-import compilations. Native fixtures execute value, memory, audio, rendering, buffer, image and file contracts. Remaining source assertions need behavioral coverage. |
