...
| Id | Sev | Status | Defect | Where | Fix |
| --- | --- | --- | --- | --- | --- |
| LW-1 | H | partial | Hand-written glTF loader control flow | templates/gltf-loader-cpp.ts, gltf/ | Accessors, transforms, hierarchy, material assembly, sampler selection, texture and material caches, extension texture fetching and material construction lower from pinned ASTs. Material scheduling, mesh construction and animation orchestration retain hand-written control flow. |
