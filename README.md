...
*A few of the 128 curated parity scenes, compiled to native C++ and rendered
...
- 128 curated Babylon Lite parity scenes, plus primitives and project-owned differential regression gates.
