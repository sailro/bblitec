...
*A few of the 153 curated parity scenes, compiled to native C++ and rendered
...
- 153 curated Babylon Lite parity scenes, plus primitives and project-owned differential regression gates.
