...
*A few of the 141 curated parity scenes, compiled to native C++ and rendered
...
- 141 curated Babylon Lite parity scenes, plus primitives and project-owned differential regression gates.
