...
*A few of the 64 curated parity scenes, compiled to native C++ and rendered
...
- 64 curated Babylon Lite parity scenes, plus primitives and project-owned differential regression gates.
