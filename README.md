...
*A few of the 198 curated parity scenes and 11 demos, compiled to native C++
and rendered on both GPU backends — click any frame for the measured numbers.*

## Current proof points

- Pinned upstream: `@babylonjs/lite@1.26.0`,
  commit `69c8588f39454f94b6c1657193672cee9f03ee0e`.
