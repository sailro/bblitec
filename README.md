...
*A few of the 126 curated parity scenes, compiled to native C++ and rendered
...
- 126 curated Babylon Lite parity scenes, plus primitives and project-owned differential regression gates.
