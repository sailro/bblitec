...
*A few of the 139 curated parity scenes, compiled to native C++ and rendered
...
- 139 curated Babylon Lite parity scenes, plus primitives and project-owned differential regression gates.
