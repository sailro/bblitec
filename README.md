...
*A few of the 136 curated parity scenes, compiled to native C++ and rendered
...
- 136 curated Babylon Lite parity scenes, plus primitives and project-owned differential regression gates.
