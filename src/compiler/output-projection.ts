...
${jsDataInclude}${cameraMathInclude}${spriteInclude}${billboardInclude}${nodeParticleInclude}${physicsInclude}${navigationInclude}${audioInclude}${imageInclude}${shadowInclude}${postProcessInclude}
#include <cmath>
#include <exception>
