...
${workerInclude}${jsDataInclude}${cameraMathInclude}${cameraProjectionInclude}${clusteredInclude}${normalizeVec3Include}${lookDirectionInclude}${mat4InvertInclude}${spriteInclude}${billboardInclude}${spriteAnimationInclude}${nodeParticleInclude}${physicsInclude}${navigationInclude}${audioInclude}${imageInclude}${uiInclude}${shadowInclude}${postProcessInclude}
#include <cmath>
#include <exception>
