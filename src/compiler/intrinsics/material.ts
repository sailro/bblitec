...
function compileCreateSolidTexture2D(context: MaterialIntrinsicContext, call: ts.CallExpression): Value | undefined {
    ...
    const channels = call.arguments
        .slice(1)
        .map((argument) => context.compileNumber(argument));
...
function compileSetStandardEmissiveTexture(context: MaterialIntrinsicContext, call: ts.CallExpression): Value | undefined {
    ...
    context.expectKind(texture, "render-texture", argumentAt(call, 1));
...
const materialIntrinsicHandlers = new EmissionMap<string, (context: MaterialIntrinsicContext, call: ts.CallExpression) => Value | undefined>([
    ...
    ["createShaderMaterial", compileCreateShaderMaterial],
    ["createStorageBuffer", compileCreateStorageBuffer],
    ["updateStorageBuffer", compileUpdateStorageBuffer],
    ["disposeStorageBuffer", compileDisposeStorageBuffer],
    ["setShaderStorageBuffer", compileSetShaderStorageBuffer],
    ["setShadowCasterMaterial", compileSetShadowCasterMaterial],
    ...
    ["setPbrGammaAlbedo", compileSetPbrGammaAlbedo],
    ["setShadowOnly", compileSetShadowOnly],
    ["setPbrUnlit", compileSetPbrUnlit],
    ["setPbrSkybox", compileSetPbrSkybox],
    ["setPbrMetallicReflectance", compileSetPbrMetallicReflectance],
    ["setPbrSubsurface", compileSetPbrSubsurface],
    ["setPbrClearCoat", compileSetPbrClearCoat],
    ["setPbrIridescence", compileSetPbrIridescence],
    ["enablePbrLightmap", compileEnablePbrLightmap],
    ["setPbrLightmap", compileSetPbrLightmap],
    ["setPbrAnisotropy", compileSetPbrAnisotropy],
    ["installPbrTracking", compileInstallPbrTracking],
    ["installStdTracking", compileInstallPbrTracking],
