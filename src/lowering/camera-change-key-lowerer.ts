    ...
    const body = lowerPinnedFunction(
        ...
        ],
        {
            ...
            memberBindings: new Map([
                [
                    "camera._projFov",
                    { cpp: "camera.projection_fov", type: "scalar" },
                ],
                [
                    "camera._projNear",
                    { cpp: "camera.projection_near", type: "scalar" },
                ],
                [
                    "camera._projFar",
                    { cpp: "camera.projection_far", type: "scalar" },
                ],
                [
                    "camera._projRev",
                    { cpp: "camera.projection_revision", type: "scalar" },
                ],
                [
