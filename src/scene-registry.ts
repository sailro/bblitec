...
const sceneInputs: readonly SceneInput[] = [
    ...
    {
        id: "scene104",
        name: "Scene 104 - Havok Character Controller",
        source: "corpus/babylon-lite/lab/lite/src/lite/scene104.ts",
        title: "Babylon Lite Native - Character Controller",
        parity: {
            referenceSearch: "?captureFrame=35",
            maxFullMad: 0.015,
            maxForegroundMad: 0.014,
            backgroundColor: [51, 51, 76],
            backgroundThreshold: 30,
            nativeEnvironment: { BBLITE_SCREENSHOT_FRAME: "50" },
        },
    },
    {
        id: "scene105",
        name: "Scene 105 - Havok Character Moving Platform",
        source: "corpus/babylon-lite/lab/lite/src/lite/scene105.ts",
        title: "Babylon Lite Native - Character Moving Platform",
        parity: {
            referenceSearch: "?captureFrame=55",
            maxFullMad: 0.3,
            maxForegroundMad: 0.23,
            backgroundColor: [51, 51, 76],
            backgroundThreshold: 30,
            nativeEnvironment: { BBLITE_SCREENSHOT_FRAME: "75" },
        },
    },
    {
        id: "scene102",
    ...
    },
    {
        ...
        parity: {
            referenceSearch: "?captureFrame=5",
            // The exact automated pose is pixel-exact on both backends.
            maxFullMad: 0.001,
            maxForegroundMad: 0.001,
            backgroundColor: [51, 51, 76],
            backgroundThreshold: 30,
    ...
    },
    {
        id: "playroom",
        name: "The Playroom",
        source: "corpus/babylon-lite/lab/lite/src/demos/playroom.ts",
        sourceOrigin: "babylon-lite-application",
