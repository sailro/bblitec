...
//   Linux Canvas2D bakes use the screenshot renderer's flags. Other hosts
//   retain their default Canvas2D renderer. The three baked-byte harnesses (HDR,
...
/** Linux's default Canvas2D rasterizer differs from the Vulkan capture path. */
