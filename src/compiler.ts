...
class Compiler implements LoweringServices {
    ...
    public emitVariableDeclaration(declaration: ts.VariableDeclaration): void {
        ...
        value = this.bindings.bindSceneNodeVector(value);
        value = this.bindings.bindCameraVector(value);
        if (forwardCallback) {
        ...
        value =
            this.bindings.referenceRecordValue(
                value,
                declaration.initializer,
            ) ?? value;
    ...
    private emitArrayBindingDeclaration(
        ...
        const bindElement = (
            ...
            if (bound.kind === "record") {
                ...
                if (stored.kind === "record") {
                    stored = this.bindings.materializeRecordScalars(
                        stored,
        ...
        if (value.kind === "data" && tupleArity !== undefined) {
            ...
            const temporary = this.bindings.bindDataTuple(
                value,
                tupleArity,
                "tuple",
                initializerBoundary,
