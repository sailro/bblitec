...
- [ ] Remaining core-library forms: RegExp replacement callbacks, `localeCompare` locale lists and options beyond numeric/sensitivity, `Set.entries()`, dynamic mixed-tuple indexing, rest bindings and length-changing methods. M; localization and collection transforms reach these forms.
