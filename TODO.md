...
| Direct morph | Multiple targets, one shared weights object attached to several meshes, runtime attachment variants and native-coordinate thin-instance streams. Definite scene-code attachments now compose Standard and PBR morph variants with local vertices and live world matrices; the remaining attachment/instancing combinations refuse. |
