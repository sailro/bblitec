...
- [ ] Promise caches need local/nullable promise rebinding; inline async reactions, callback properties and adoption into wider/void results refuse (async.ts, data-lowering.ts). M; retained loaders and request caches.
