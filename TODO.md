...
- [ ] Remaining core-library forms: dynamic mixed-tuple writes, mixed-tuple destructuring assignments and length-changing methods. M; collection transforms reach these forms.
