...
- [ ] Remaining core-library forms: RegExp replacement callbacks, stored `Set.entries()` iterators, dynamic mixed-tuple indexing, rest bindings and length-changing methods. M; localization and collection transforms reach these forms.
