...
- [ ] Retained selectors need relational/matching-list functions beyond :not and general structural chains across projected grid containers. Generated content still needs counters/images, typed attribute fallbacks and decorations/layout substitutions requiring authored handles (ui-selector.ts, ui-projection.ts, pal_ui_rml.cpp). L.
