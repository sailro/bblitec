...
- [ ] Remaining core-library forms: RegExp replacement callbacks, dynamic mixed-tuple writes, mixed-tuple destructuring assignments and length-changing methods. M; localization and collection transforms reach these forms.
