// Generated by tools/generate-emoji-presentation.mjs.
// Node 22.22.1, ICU 78.2, Unicode 17.0.
#pragma once
...
inline constexpr std::array<std::pair<char32_t, char32_t>, 81> ui_emoji_ranges{{
...
inline bool ui_default_emoji_presentation(char32_t point) {
    const auto range =
        std::lower_bound(ui_emoji_ranges.begin(), ui_emoji_ranges.end(), point,
