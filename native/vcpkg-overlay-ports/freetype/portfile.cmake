...
# Windows system fonts use SFNT containers. Static packages register only
# their TrueType/CFF drivers and rasterizers; other builds retain the registry set.
if(VCPKG_TARGET_IS_WINDOWS AND VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    list(APPEND FEATURE_OPTIONS "-DBBLITE_FREETYPE_MODULES=${CMAKE_CURRENT_LIST_DIR}/ftmodule.h")
endif()
...
vcpkg_cmake_install()
if(VCPKG_TARGET_IS_WINDOWS AND VCPKG_LIBRARY_LINKAGE STREQUAL "static")
    configure_file("${CMAKE_CURRENT_LIST_DIR}/ftmodule.h"
        "${CURRENT_PACKAGES_DIR}/include/freetype2/freetype/config/ftmodule.h" COPYONLY)
endif()
vcpkg_copy_pdbs()
