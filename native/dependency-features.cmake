...
if("data:locale" IN_LIST BBLITE_RUNTIME_FEATURES AND NOT "locale" IN_LIST VCPKG_MANIFEST_FEATURES)
    list(APPEND VCPKG_MANIFEST_FEATURES "locale")
endif()

if("platform:http" IN_LIST BBLITE_RUNTIME_FEATURES AND NOT "http" IN_LIST VCPKG_MANIFEST_FEATURES)
