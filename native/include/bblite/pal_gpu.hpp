...
#if defined(BBLITE_HAS_PBR_RENDERER) && BBLITE_HAS_PBR_RENDERER && defined(BBLITE_HAS_SDL_GPU) &&  \
    BBLITE_HAS_SDL_GPU
SceneRun run_gpu_engine(Engine& engine);
#else
inline SceneRun run_gpu_engine(Engine&) { BBLITE_RUN_RETURN(false); }
#endif
...
#else
inline SceneRun run_dawn_engine(Engine&) { BBLITE_RUN_RETURN(false); }
#endif
...
#else
inline bool run_sprite_gpu_engine(Engine&) { return false; }
#endif
...
#else
inline bool run_sprite_dawn_engine(Engine&) { return false; }
#endif
...
#else
inline bool run_effect_gpu_engine(Engine&) { return false; }
#endif
...
#else
inline bool run_effect_dawn_engine(Engine&) { return false; }
#endif
...
#else
inline bool run_frame_graph_gpu_engine(Engine&) { return false; }
#endif
...
#else
inline bool run_frame_graph_dawn_engine(Engine&) { return false; }
#endif
