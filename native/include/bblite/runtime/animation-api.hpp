...
void set_animation_weight(PropertyAnimationGroup group, float weight);
...
void cross_fade_animation_groups(PropertyAnimationManager manager, Engine& engine,
                                 ...
                                 AnimationWeightFadeTarget to_group, float duration_ms,
                                 float to_weight);
...
void tick_animation_group_reference(Engine& engine, const AnimationGroupReference& group,
                                    double delta_ms);
void seek_animation_manager(PropertyAnimationManager manager, Engine& engine, float time);
void go_to_frame(PropertyAnimationGroup group, Engine& engine, float frame);
