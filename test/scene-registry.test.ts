...
test("registers unique generated scene targets", () => {
    assert.deepEqual(
        scenes.map(({ id }) => id),
        ["primitives", "scene1", "scene3", "scene6", "scene14", "scene24", "scene28", "scene29", "scene31", "scene33", "scene35", "scene216", "scene150", "scene178", "scene210", "scene212", "scene243", "scene246", "scene247", "scene254", "scene255", "scene258", "scene259", "scene265", "scene2", "scene7", "scene8", "scene5", "scene10", "scene13", "scene32", "scene159", "scene161", "scene163", "audit-shader-frame-graph", "regression-instanced-ground", "regression-morph-ground", "regression-compiler-state", "scene168", "scene176", "scene213", "scene151", "scene154", "scene240", "regression-track-clamp", "scene116", "scene145", "scene146", "scene248", "scene245", "scene249", "scene257", "scene266", "scene273", "scene274", "tetris-blocks", "tetris-logic", "tetris-well", "tetris-particles", "tetris-modes", "tetris-retire", "tetris-sparks"],
    );
