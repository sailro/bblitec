...
test(
    "native viewer preserves membership, node pose, line topology and retained hook lifetime",
    { skip: !tools },
    () => {
        ...
        runNativeFixtureCompiler(tools!, [
            ...
            "/external:W0",
            "test/fixtures/physics-viewer-lifecycle-check.cpp",
