...
test("bare shader samplers normalize identically for programs, prelude and IR", () => {
    ...
    assert.deepEqual(
        ...
        lowerWgslShaderProgram(explicit),
    );
...
test(
    "CSM disposal releases captures and tolerates dispatch and owner destruction",
    {
        skip: !nativeTools,
    },
    () => {
