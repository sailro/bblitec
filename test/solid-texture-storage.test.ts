...
test("solid Texture2D helper and container identities match the pinned producer", async () => {
    ...
    const engine = {
        _device: {
            ...
            createSampler: (options: unknown) => {
                samplers.push(options);
                return {};
            },
            queue: {
...
test(
    "generated solid texture storage preserves identity, payload and independent file IDs",
    { skip: !tools },
    () => {
