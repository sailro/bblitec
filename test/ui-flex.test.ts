...
test("retained flex and box declarations survive static projection and live writes", () => {
    const style =
        "display:flex;flex-flow:WRAP COLUMN;align-content:start;align-self:end;flex:1 1 auto;flex-basis:30%;flex-grow:2;flex-shrink:0;flex-wrap:wrap-reverse;row-gap:4px;column-gap:8px;padding-top:2px;padding-right:3px;padding-bottom:4px;padding-left:5px;margin-left:auto;margin-right:-2px;";
