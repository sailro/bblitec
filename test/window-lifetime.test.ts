...
test(
    "device owners release partial construction once and preserve borrowed devices and windows",
    { skip: !nativeTools },
    () => {
...
test(
    "window identity and geometry survive rebuilds; final exit and exceptions clean up",
    { skip: !nativeTools },
    () => {
